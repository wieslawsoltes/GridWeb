...
execFileSync(process.platform === 'win32' ? 'npm.cmd' : 'npm', ['exec','--yes','--package=esbuild@0.28.2','--','esbuild','src/worker.js','--bundle','--format=esm','--platform=browser','--target=es2022','--outfile=blazor/src/wwwroot/worker.js','--legal-comments=eof'], { stdio: 'inherit' });
